...
# Jenkins业务类
class JenkinsOperation(Operation):
    ...
    def delete_all_jobs(self):
        ...
        return Result(f"{jobs_names} all deleted")
...
if __name__ == '__main__':
    clear_log()
    logger = Mylog(log_level="INFO")
    admin = Jenkins('http://127.0.0.1:8080', 'admin', 'admin')
    admin.use_jenkins.get_all_job_name()
    ...
    # admin.use_jenkins.create_job_with_dsl(job_dsl, "xxjob")
    # admin.use_jenkins.create_job_with_dsl(job_dsl, "xxjob")
    # admin.use_jenkins.delete_all_jobs()